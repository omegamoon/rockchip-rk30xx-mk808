...
static const u16 rt3261_dsp_init[][2] = {
	{0x3fd2, 0x0038}, {0x3fd2, 0x0038}, {0x229C, 0x0fa0}, {0x22d2, 0x8400}, {0x22ee, 0x0000},
...
static const u16 rt3261_dsp_aec_ns_fens[][2] = {
	...
	{0x2381, 0x4000},
	{0x2398, 0x0020},
	{0x23B4, 0x0005},// 2012-1206 zhou tao //{0x23B4, 0x0012},
	{0x23BD, 0x0100},
	{0x23D1, 0xFF80},
	{0x23D5, 0x7FFF},
	{0x2303, 0x0901},// 2012-1206 zhou tao //{0x2303, 0x0931},
	{0x2333, 0x0008},
	{0x2349, 0x6800},
	{0x2363, 0x0100},
	{0x236F, 0x0A0A},
	{0x2374, 0x2400},
	{0x2382, 0x0400},
	{0x238C, 0x1000},// 2012-1206 zhou tao //{0x238C, 0x0400},
	{0x23A5, 0x0006},
	{0x23B7, 0x0008},
	{0x23BE, 0x2400},
	{0x23D2, 0xFF80},
	{0x23ED, 0x0300},
	{0x2304, 0x031e},// 2012-1206 zhou tao //{0x2304, 0xC31F},
	{0x230C, 0x0200},// 2012-1206 zhou tao //{0x230C, 0x0900},
	{0x2337, 0x0002},
	{0x2360, 0x0080},
	{0x2364, 0x0078},
	{0x2370, 0x0F00},
	...
	{0x23A6, 0x7FFF},
	{0x23BB, 0x1000},
	{0x23CF, 0x0600},// 2012-1206 zhou tao //{0x23CF, 0x7FFF},
	{0x2305, 0x0005},
	{0x232F, 0x0080},
	{0x2339, 0x0010},
	{0x2361, 0x1800},
	{0x2380, 0x7FFF},
	{0x2384, 0x0005},
	{0x23B3, 0x0006},// 2012-1206 zhou tao //{0x23B3, 0x0018},
	{0x23BC, 0x0130},
	{0x2328, 0x7FFF},
	{0x233A, 0x2000},// 2012-1206 zhou tao //{0x233A, 0x7FFF},
	{0x233B, 0x2000},// 2012-1206 zhou tao //{0x233B, 0x7FFF},
	{0x233C, 0x1000},// 2012-1206 zhou tao //{0x233C, 0x7FFF},
	{0x2302, 0x0101},
	{0x22F2, 0x0040},
	{0x230A, 0x1B00},
	{0x22FB, 0x0000},
...
int rt3261_dsp_probe(struct snd_soc_codec *codec)
{
	...
	if (codec == NULL)
		return -EINVAL;
	dev_err(codec->dev, "%s:init rt3261 dsp !\n",__func__);
