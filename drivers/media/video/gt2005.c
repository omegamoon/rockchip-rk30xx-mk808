...
#define CONFIG_SENSOR_WhiteBalance	   1//yemk modify
#define CONFIG_SENSOR_Brightness	0
#define CONFIG_SENSOR_Contrast      0
#define CONFIG_SENSOR_Saturation    0
#define CONFIG_SENSOR_Effect        0
#define CONFIG_SENSOR_Scene         0//yemk modify
#define CONFIG_SENSOR_DigitalZoom   0
#define CONFIG_SENSOR_Focus         0
#define CONFIG_SENSOR_Exposure      1
#define CONFIG_SENSOR_Flash         0//yemk modify
...
/* YUV Init setting */
 ...
 {0x0460, 0x80}, 
	...
	{0x0111 , 0x80},
	{0x0112 , 0x01},
	{0x0113 , 0xe0}, //vga  640*480
#else
	{0x0110, 0x03},
	{0x0111, 0x20},
	{0x0112, 0x02},
	{0x0113, 0x58},// svga 800*600
...
{
    struct i2c_client *client = to_i2c_client(to_soc_camera_control(icd));
	//printk("yemk:sensor_set_brightness value - qctrl->minimum %d\n",(value - qctrl->minimum));
...
{
    struct i2c_client *client = to_i2c_client(to_soc_camera_control(icd));
	//printk("yemk:sensor_set_effect value - qctrl->minimum %d\n",(value - qctrl->minimum));
    if ((value >= qctrl->minimum) && (value <= qctrl->maximum))
    {
...
{
    struct i2c_client *client = to_i2c_client(to_soc_camera_control(icd));
	//printk("yemk:sensor_set_scene value - qctrl->minimum %d\n",(value - qctrl->minimum));
    if ((value >= qctrl->minimum) && (value <= qctrl->maximum))
    {
...
{
    struct i2c_client *client = to_i2c_client(to_soc_camera_control(icd));
	//printk("yemk:sensor_set_whiteBalance value - qctrl->minimum %d\n",(value - qctrl->minimum));
    if ((value >= qctrl->minimum) && (value <= qctrl->maximum))
    {
