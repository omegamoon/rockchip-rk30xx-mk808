...
#if defined(CONFIG_TPS65910_RTC)
...
EXPORT_SYMBOL(tps65910_shutdown);
...
tps65910_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	DBG("tps65910_i2c_probe: addr=0x%02x\n", client->addr);
...
static int tps65910_suspend(struct i2c_client *client, pm_message_t mesg)
{
        int err;

        printk("%s...\n",__FUNCTION__);
        return  tps65910_i2c_write_u8(TPS65910_I2C_ID0, 0x25, TPS65910_REG_VDD1_OP);

}

static int tps65910_resume(struct i2c_client *client)
{
        printk("%s...\n",__FUNCTION__);

        return tps65910_i2c_write_u8(TPS65910_I2C_ID0, 0x33, TPS65910_REG_VDD1_OP);
}
...
//	.suspend     =   tps65910_suspend,
//	.resume       =  tps65910_resume,
};
...
static int proc_tps65910_show(struct seq_file *s, void *v)
{
	...
	tps65910_i2c_read_u8(TPS65910_I2C_ID0, &val, TPS65910_REG_VDD1_SR);
	seq_printf(s, "VDD1_SR_REG=0x%x, Value=0x%x\n", TPS65910_REG_VDD1_SR, val);
	...
	tps65910_i2c_read_u8(TPS65910_I2C_ID0, &val, TPS65910_REG_DCDCCTRL);
	seq_printf(s, "DCDCCTRL_REG=0x%x, Value=0x%x\n", TPS65910_REG_DCDCCTRL, val);

	tps65910_i2c_read_u8(TPS65910_I2C_ID0, &val, TPS65910_REG_EN1_SMPS_ASS);
	seq_printf(s, "EN1_SMPS_ASS_REG=0x%x, Value=0x%x\n", TPS65910_REG_EN1_SMPS_ASS, val);
	tps65910_i2c_read_u8(TPS65910_I2C_ID0, &val, TPS65910_REG_EN2_SMPS_ASS);
	seq_printf(s, "EN2_SMPS_ASS_REG=0x%x, Value=0x%x\n", TPS65910_REG_EN2_SMPS_ASS, val);
	
	tps65910_i2c_read_u8(TPS65910_I2C_ID0, &val, TPS65910_REG_INT_STS);
	seq_printf(s, "INT_STS_REG=0x%x, Value=0x%x\n", TPS65910_REG_INT_STS, val);	
